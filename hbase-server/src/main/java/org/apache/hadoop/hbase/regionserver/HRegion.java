...
public class HRegion implements HeapSize, PropagatingConfigurationObserver, Region {
    ...
    public HRegion(final Path tableDir, final WAL wal, final FileSystem fs,
        ...
        // 创建 HRegion
        this(
                // 创建 HRegionFileSystem
                new HRegionFileSystem(confParam, fs, tableDir, regionInfo),
    ...
    public OperationStatus[] batchMutate(Mutation[] mutations, boolean atomic, long nonceGroup,
        ...
        // 执行批量插入 Put
        return batchMutate(
                new MutationBatchOperation(this, mutations, atomic, nonceGroup, nonce));
    }
    ...
    OperationStatus[] batchMutate(BatchOperation<?> batchOp) throws IOException {
        ...
        try {
            // batchOp = MutationBatchOperation
    ...
    public static HRegion createHRegion(final RegionInfo info, final Path rootDir,
            ...
            throws IOException {
        /**
         * creating HRegion TEST:test_create_table
         * HTD == 'TEST:test_create_table',
         * {NAME => 'info',
         * VERSIONS => '5',
         ...
         * BLOCKCACHE => 'true',
         * BLOCKSIZE => '65536'}
         * RootDir = hdfs://hadoop102:8020/hbase/.tmp
         * Table name == TEST:test_create_table
         */
    ...
    private void requestFlushIfNeeded() throws RegionTooBusyException {
        // 判断 HRegion 的 memstore 大小是否大于 128M
    ...
    private void requestFlush0(FlushLifeCycleTracker tracker) {
        ...
        if (shouldFlush) {
            ...
            // 调用 MemStoreFlusher.requestFlush()
